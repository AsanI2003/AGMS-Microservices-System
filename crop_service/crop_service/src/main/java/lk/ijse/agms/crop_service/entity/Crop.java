package lk.ijse.agms.crop_service.entity;
...
public class Crop {
    ...
    public Crop(String cropID, String cropName, String category, CropStatus cropStatus, String scientificName, String zoneID, String cropImage) {
        this.cropID = cropID;
        this.cropName = cropName;
        this.category = category;
        this.cropStatus = cropStatus;
