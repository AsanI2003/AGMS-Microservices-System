...
public class ZoneDTO {
    ...
    public ZoneDTO(String zoneID, String zoneName, String zoneLocation, Double zoneSize, Double minTemp, Double maxTemp, Double minHumidity, Double maxHumidity, String deviceId) {
        this.zoneID = zoneID;
        this.zoneName = zoneName;
        this.zoneLocation = zoneLocation;
        this.zoneSize = zoneSize;
